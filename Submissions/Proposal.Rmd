...
## Project Detail
We apply Monte Carlo simulation to study the behavior of a one-sample hypothesis test for binomially distributed data.  We focus on the normal approximation of binomial and test with the proportion. Since this test relies on asymptotic assumptions, Monte Carlo simulation provides a natural framework for evaluating its behavior. Let
$$
